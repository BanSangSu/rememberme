...
public class IntentHelperTest extends BaseAndroidTestCase {
  ...
  public void getNoteIntent() {
    ...
    assertTrue(intent.getParcelableExtra(ConstantsBase.INTENT_NOTE) instanceof Note);
    assertEquals(NOTE_TITLE, ((Note) intent.getParcelableExtra(ConstantsBase.INTENT_NOTE)).getTitle());
  }
