...
import it.feio.android.rememberme.exceptions.checked.BackupAttachmentException;
...
public final class BackupHelper {
  ...
  public static void exportNote(File backupDir, Note note) {
    if (Boolean.TRUE.equals(note.isLocked())) {
      note.setContent(Security.encrypt(note.getContent(), Prefs.getString(ConstantsBase.PREF_PASSWORD, "")));
    }
