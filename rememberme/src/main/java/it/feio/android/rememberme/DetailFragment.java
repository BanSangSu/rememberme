...
import static it.feio.android.rememberme.BaseActivity.TRANSITION_HORIZONTAL;
import static it.feio.android.rememberme.BaseActivity.TRANSITION_VERTICAL;
...
import it.feio.android.rememberme.async.AttachmentTask;
import it.feio.android.rememberme.async.bus.NotesUpdatedEvent;
import it.feio.android.rememberme.async.bus.PushbulletReplyEvent;
...
import it.feio.android.rememberme.async.notes.SaveNoteTask;
import it.feio.android.rememberme.databinding.FragmentDetailBinding;
import it.feio.android.rememberme.db.DbHelper;
import it.feio.android.rememberme.exceptions.checked.UnhandledIntentException;
import it.feio.android.rememberme.helpers.AttachmentsHelper;
import it.feio.android.rememberme.helpers.IntentHelper;
import it.feio.android.rememberme.helpers.LogDelegate;
import it.feio.android.rememberme.helpers.PermissionsHelper;
import it.feio.android.rememberme.helpers.TagOpenerHelper;
import it.feio.android.rememberme.helpers.date.DateHelper;
import it.feio.android.rememberme.helpers.date.RecurrenceHelper;
import it.feio.android.rememberme.helpers.notifications.NotificationChannels.NotificationChannelNames;
import it.feio.android.rememberme.helpers.notifications.NotificationsHelper;
...
import it.feio.android.rememberme.models.Tag;
import it.feio.android.rememberme.models.adapters.AttachmentAdapter;
import it.feio.android.rememberme.models.adapters.CategoryRecyclerViewAdapter;
import it.feio.android.rememberme.models.adapters.PlacesAutoCompleteAdapter;
import it.feio.android.rememberme.models.listeners.OnAttachingFileListener;
import it.feio.android.rememberme.models.listeners.OnGeoUtilResultListener;
import it.feio.android.rememberme.models.listeners.OnNoteSaved;
import it.feio.android.rememberme.models.listeners.OnReminderPickedListener;
import it.feio.android.rememberme.models.listeners.RecyclerViewItemClickSupport;
import it.feio.android.rememberme.models.views.ExpandableHeightGridView;
import it.feio.android.rememberme.utils.AlphaManager;
import it.feio.android.rememberme.utils.BitmapHelper;
import it.feio.android.rememberme.utils.ConnectionManager;
import it.feio.android.rememberme.utils.Display;
import it.feio.android.rememberme.utils.FileHelper;
import it.feio.android.rememberme.utils.FileProviderHelper;
import it.feio.android.rememberme.utils.GeocodeHelper;
import it.feio.android.rememberme.utils.IntentChecker;
import it.feio.android.rememberme.utils.KeyboardUtils;
import it.feio.android.rememberme.utils.PasswordHelper;
import it.feio.android.rememberme.utils.ReminderHelper;
import it.feio.android.rememberme.utils.ShortcutHelper;
import it.feio.android.rememberme.utils.StorageHelper;
import it.feio.android.rememberme.utils.TagsHelper;
import it.feio.android.rememberme.utils.TextHelper;
import it.feio.android.rememberme.utils.date.DateUtils;
import it.feio.android.rememberme.utils.date.ReminderPickers;
...
import it.feio.android.rememberme.models.PasswordValidator;
...
public class DetailFragment extends BaseFragment implements OnReminderPickedListener,
  ...
  private void addSketchedImageIfPresent() {
    if (mainActivity.getSketchUri() != null) {
      Attachment mAttachment = new Attachment(mainActivity.getSketchUri(), ConstantsBase.MIME_TYPE_SKETCH);
  ...
  private void handleIntents() {
    ...
    if (IntentChecker
        .checkAction(i, Intent.ACTION_SEND, Intent.ACTION_SEND_MULTIPLE, ConstantsBase.INTENT_GOOGLE_NOW)
        && i.getType() != null) {
    ...
    if (IntentChecker
        .checkAction(i, Intent.ACTION_MAIN, ConstantsBase.ACTION_WIDGET_SHOW_LIST, ConstantsBase.ACTION_SHORTCUT_WIDGET,
            ConstantsBase.ACTION_WIDGET)) {
      showKeyboard = true;
    }
  ...
  private void initViewFooter() {
    String creation = DateHelper
        .getFormattedDate(noteTmp.getCreation(), Prefs.getBoolean(ConstantsBase.PREF_PRETTIFIED_DATES, true));
    binding.creation
...
//					((View)event.getLocalState()).setVisibility(View.VISIBLE);
  ...
  private void setTagMarkerColor(Category tag) {
    ...
    String colorsPref = Prefs.getString("settings_colors_app", ConstantsBase.PREF_COLORS_APP_DEFAULT);
  ...
  private void pinNote() {
    PendingIntent notifyIntent = IntentHelper
        .getNotePendingIntent(getContext(), SnoozeActivity.class, ConstantsBase.ACTION_PINNED, note);
    ...
    PendingIntent unpinIntent = IntentHelper
        .getNotePendingIntent(getContext(), SnoozeActivity.class, ConstantsBase.ACTION_DISMISS, note);
        ...
        if (swiping) {
          ...
          if (Math.abs(x - startSwipeX) > ConstantsBase.SWIPE_OFFSET) {
            ...
            transaction.replace(R.id.fragment_container, mDetailFragment, MainActivity.FRAGMENT_DETAIL_TAG)
                .addToBackStack(
                    MainActivity.FRAGMENT_DETAIL_TAG).commit();
          }
        }
        break;
