...
package it.feio.android.rememberme.intro;
...
public class IntroActivity extends AppIntro2 {
  ...
  public void onDonePressed() {
    Prefs.edit().putBoolean(ConstantsBase.PREF_TOUR_COMPLETE, true).apply();
    finish();
  }

  public static boolean mustRun() {
    return !OmniNotes.isDebugBuild() && !Prefs.getBoolean(ConstantsBase.PREF_TOUR_COMPLETE, false);
  }
