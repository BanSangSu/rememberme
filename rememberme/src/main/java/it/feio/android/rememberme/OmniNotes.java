...
import static it.feio.android.rememberme.utils.Constants.PACKAGE;
...
public class OmniNotes extends MultiDexApplication {
  ...
  public AnalyticsHelper getAnalyticsHelper() {
    if (analyticsHelper == null) {
      boolean enableAnalytics = Prefs.getBoolean(ConstantsBase.PREF_SEND_ANALYTICS, true);
      try {
        String[] analyticsParams = BuildConfig.ANALYTICS_PARAMS.split(ConstantsBase.PROPERTIES_PARAMS_SEPARATOR);
