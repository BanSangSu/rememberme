 ...
 */
package it.feio.android.rememberme.db;

import static it.feio.android.checklistview.interfaces.Constants.UNCHECKED_SYM;
import static it.feio.android.rememberme.utils.Constants.DATABASE_NAME;
...
import it.feio.android.rememberme.async.upgrade.UpgradeProcessor;
import it.feio.android.rememberme.exceptions.DatabaseException;
...
import it.feio.android.rememberme.models.Stats;
import it.feio.android.rememberme.models.Tag;
import it.feio.android.rememberme.utils.AssetUtils;
import it.feio.android.rememberme.utils.Navigation;
import it.feio.android.rememberme.utils.Security;
...
public class DbHelper extends SQLiteOpenHelper {
      ...
      if (cursor.moveToFirst()) {
        do {
          ...
          if (Boolean.TRUE.equals(note.isLocked())) {
            note.setContent(
                Security.decrypt(note.getContent(), Prefs.getString(ConstantsBase.PREF_PASSWORD, "")));
          }
  ...
  public List<Note> getNotesByCategory(Long categoryId) {
    ...
    boolean filterArchived = Prefs
        .getBoolean(ConstantsBase.PREF_FILTER_ARCHIVED_IN_CATEGORIES + categoryId, false);
    try {
      String whereCondition = " WHERE "
